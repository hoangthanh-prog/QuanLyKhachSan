...
namespace QL_KhachSan.Areas.Admin.Controllers
{
    public class KhachHangsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MaKH,TenKH,Gmail,MatKhau,GioiTinh,NgaySinh,TinhThanh")] KhachHang khachHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaKH,TenKH,Gmail,MatKhau,GioiTinh,NgaySinh,TinhThanh")] KhachHang khachHang)
        {
            if (ModelState.IsValid)
            {
